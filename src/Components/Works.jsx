const Works = () => {
  return (
    <div
      ...
      className="w-full h-auto md:h-screen p-4"
    >
      ...
      <div className="flex justify-center items-center flex-col gap-4 md:gap-6 lg:gap-8 px-4">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-9xl text-center w-full md:w-3/4 lg:w-1/2 font-bold leading-tight md:leading-none tracking-tighter">
